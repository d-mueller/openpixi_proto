...
public class Cell {
    ...
    public final SU2GroupElement[] U0 = new SU2GroupElement[3];
    public final SU2GroupElement[] U1 = new SU2GroupElement[3];
    public final SU2AlgebraElement[] E = new SU2AlgebraElement[3];
